...
# This problem set is structured so that you will write a number of modular functions
# and then glue them together to form the complete word playing game.
# Instead of waiting until the entire game is ready, you should test each function you write, individually,
