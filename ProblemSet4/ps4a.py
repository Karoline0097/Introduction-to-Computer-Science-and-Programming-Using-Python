...
#
# Problem #2:
# Displaying a hand in a user-friendly way
...
def updateHand(hand, word):
    ...
    # make copy of hand to not mutate the hand passed in
    handcop = hand.copy()
